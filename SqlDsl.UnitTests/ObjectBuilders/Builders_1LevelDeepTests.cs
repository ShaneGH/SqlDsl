...
namespace SqlDsl.UnitTests.ObjectBuilders
{
    ...
    public class Builders_1LevelDeepTests
    {
        ...
        public void Build_WithSimpleProperties_BuildsCorrectly()
        {
            // arrange
            // act
            var result = Builders.GetBuilder<SimpleProperties>().Build(new TestObjectGraph()
            {
                SimpleProps = new [] 
                {
        ...
        public void Build_ExpectingIntGetsNull_ThrowsError()
        {
            ...
            Assert.Throws(
                ...
                () => Builders.GetBuilder<SimpleProperties>().Build(new TestObjectGraph()
                {
                    SimpleProps = new [] 
                    {
        ...
        public void Build_ParentHasProperties_BuildsCorrectly()
        {
            // arrange
            // act
            var result = Builders.GetBuilder<SimplePropertiesChild>().Build(new TestObjectGraph()
            {
                SimpleProps = new [] 
                {
                    ("Property1", new object[] { "Hello" }.Skip(0), false),
        ...
        public void Build_WithMultipleSimpleProperties_BuildsCorrectly()
        {
            // arrange
            // act
            var result = Builders.GetBuilder<MultipleSimpleProperties>().Build(new TestObjectGraph()
            {
                SimpleProps = new [] 
                {
                    ("Property1", new object[] { "Hello", "Hello again" }.Skip(0), false),
        ...
        static ReusableObjectGraph CollectionTestValues() => new TestObjectGraph()
        {
