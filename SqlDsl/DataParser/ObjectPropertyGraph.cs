...
namespace SqlDsl.DataParser
{
    ...
    {
        public static readonly SimpleProp[] EmptySimpleProps = new SimpleProp[0];
        public static readonly ComplexProp[] EmptyComplexProps = new ComplexProp[0];
        public static readonly SimpleConstructorArg[] EmptySimpleConstructorArgs = new SimpleConstructorArg[0];
        public static readonly ComplexConstructorArg[] EmptyComplexConstructorArgs = new ComplexConstructorArg[0];
