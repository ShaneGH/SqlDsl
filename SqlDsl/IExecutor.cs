...
namespace SqlDsl
{
    ...
    public interface IExecutor
    {
        ...
        /// </summary>
        Task<DbDataReader> ExecuteAsync(string sql, IEnumerable<(string name, object value)> paramaters);
        
        /// <summary>
        /// Execute a sql query and return a reader to read results
        /// </summary>
        DbDataReader Execute(string sql, IEnumerable<(string name, object value)> paramaters);
    ...
    public static class IExecutorUtils
    {
        ...
        /// </summary>
        public static Task<DbDataReader> ExecuteDebugAsync(this IExecutor executor, string sql, IEnumerable<(string name, object value)> paramaters, string[] columnNames) =>
        ...
        /// </summary>
        public static DbDataReader ExecuteDebug(this IExecutor executor, string sql, IEnumerable<(string name, object value)> paramaters, string[] columnNames) =>
            executor is IDebugExecutor ?
